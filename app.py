...
if data_loaded:
    ...
    nav_items = [
        ...
        ("💡", "Recommendations" if _dil_h == "EN" else "Öneriler", "💡 Öneriler"),
    ...
    TR_EN_REPLACEMENTS = {
        ...
        "İLÇE ÖNERİLERİ": "DISTRICT RECOMMENDATIONS",
        "İlçe Bazlı Öneriler": "District-Based Recommendations",
        ...
        "Genel Su Tasarrufu Önerileri": "General Water-Saving Recommendations",
