        ...
        with tab1:
            ...
            baraj_detay = [
                (bc1,"💧 Tahtalı Barajı","#38d1e3",
                 ...
                 [("İzmir'in en büyük su deposu.","Tahtalı Barajı, şehrin su ihtiyacının yaklaşık **%60–70'ini** tek başına karşılar. Havzası 432 km², toplam depolama kapasitesi **309 milyon m³**."),
                  ("2014–2023 Dönemi:","2014'te **%44 doluluk** zirvesi. 2023 itibarıyla **%29** — 2010'daki %38 seviyesinin altında.")],
                 "2023 Doluluk: %29  |  Kapasite: 309 M m³"),
                (bc2,"🌿 Balçova Barajı","#2ca02c",
                 "📍 Konum: Balçova İlçesi, İzmir  |  📅 Yapım: 1991–1995  |  🏗️ Tip: Beton kemer",
                 [("Küçük ama stratejik.","Balçova Barajı merkezi ilçeleri destekler. Havzası 47 km², kapasitesi **57 milyon m³**."),
                  ("2010–2023 İstikrarı:","**%26–%34 bandında** kaldı — en istikrarlı doluluk seyri.")],
                 "2023 Doluluk: %32  |  Kapasite: 57 M m³"),
                (bc3,"🚨 Gördes Barajı","#d62728",
                 "📍 Konum: Gördes İlçesi, Manisa  |  📅 Yapım: 1976–1980  |  🏗️ Tip: Toprak dolgu",
                 [("Kırılgan ama önemli.","Gördes Barajı borularla İzmir'e bağlı. Kapasitesi **176 milyon m³**. Sulama ve taşkın önleme işlevi de görür."),
                  ("2019–2021 Kriz Dönemi:","2020'de **%2**, 2021'de **%1**'e indi. Tarihi dip seviyesi.")],
                 "2023 Doluluk: %5  |  Kapasite: 176 M m³  |  Kritik Seviye"),
            ]
            img_map={"💧 Tahtalı Barajı":"tahtali.jpg","🌿 Balçova Barajı":"balcova.jpg","🚨 Gördes Barajı":"gordes.jpg"}
            for col, isim, renk, konum_tip, aciklama_listesi, durum in baraj_detay:
                with col:
                    with st.expander(isim, expanded=True):
                        try: st.image(img_map.get(isim,""), use_container_width=True)
                        ...
                        for bp, mp in aciklama_listesi: st.markdown(f"**{bp}** {mp}")
